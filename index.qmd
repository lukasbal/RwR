...
::: {.callout-warning}
The book is undergoing revision and some chapters are subject to change without notice.

If an individual chapter is still under revision this is marked at the top of the chapter. 
:::
...
and it is accompanied by the [R package RwR](https://github.com/nielsrhansen/RwR/tree/main/RwR_package) containing datasets used in the book.
